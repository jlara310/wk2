...
//If it's a get request and no state is set, redirect back to state list
...
<div id="main-content">
  <a href="../states/show.php?id=<?php echo raw_u($_GET["stateid"]); ?>">Back to State Details</a><br />

  <h1>New Territory</h1>

  <?php echo display_errors($errors); ?>

  <form action="new.php?stateid=<?php echo raw_u($_GET["stateid"]); ?>" method="post">
    Territory Name:<br />
