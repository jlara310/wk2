...
<div id="main-content">
  ...
  <form action="edit.php?id=<?php echo raw_u($salesperson['id']); ?>" method="post">
    First name:<br />
    ...
    <br />
    <input type="submit" name="submit" value="Update"  /> <a href="show.php?id=<?php echo raw_u($salesperson['id']); ?>" >Cancel</a>
  </form>
